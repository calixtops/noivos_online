          ...
          >
            ...
            <div className="h-96 w-full mt-4 relative">
              ...
              <div className="absolute bottom-4 left-4 bg-white p-4 rounded-lg shadow-lg">
                <h3 className="font-serif text-verde-700 text-lg mb-2">Casa Branca Eventos</h3>
                <p className="text-sm text-gray-600">R. Do Jangadeiro, 190 - Jacaúna</p>
                <p className="text-sm text-gray-600">Aquiraz - CE</p>
                <a 
                  href={events[0].mapLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 text-verde-600 text-sm hover:text-verde-800 inline-flex items-center"
                >
                ...
                <a
                  href="/pousadas"
                  className="mt-4 block bg-rose-600 text-white px-4 py-2 rounded-lg font-bold shadow hover:bg-rose-700 transition-all text-center"
                >

  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-cream-50 via-cream-100 to-olive-50">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-br from-cream-50 via-sage-50 to-olive-50 min-h-[80vh] flex items-center">
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Data */}
              <div className="inline-block bg-olive-100 border-2 border-olive-300 rounded-xl px-10 py-5 shadow-lg">
